...
2. Facebook/Messenger PC : capture locale des commentaires des 20 publications recentes et regles de mots-cles ajoutees ci-dessous; restent la capture des messages Messenger entrants sans endpoint public, le raccordement au planificateur commun et la recette Meta. Le telephone a sa passerelle securisee en code, mais le D1, l'application Meta, les secrets, l'App Review et le Worker restent a configurer/deployer. La capture de prospects mobile est a porter.
...
6. Porter l'attribution publicitaire verifiee et la capture mobile des prospects Facebook; Messenger dispose maintenant d'une interface et d'une passerelle securisee en code, sous reserve de configuration Meta/Cloudflare.
...
Cette voie locale capture les commentaires. Elle ne recoit pas les evenements Messenger entrants du webhook VPS, car le serveur PC n'expose volontairement que 127.0.0.1; la capture des messages Messenger, le planificateur commun de publications Facebook Page et la capture mobile des prospects restent a porter. La capture PC couvre les 20 publications recentes; les autorisations Meta et l'App Review doivent permettre la lecture de commentaires et `pages_messaging` pour les reponses privees. Une reponse automatique suit les limites appliquees par Meta; un refus ou une coupure reseau reste marque incertain sans renvoi.
