...
// "{first_name}") n'est pas du Spintax mais une variable de personnalisation
// (voir lib/personalization.js#replaceVariables) et doit rester intact. Les
// appelants qui combinent les deux passent par
// lib/personalization.js#personalizeMessage plutôt que d'appeler ce module
// directement : ce dernier résout le Spintax PUIS substitue les variables
// (ordre métier demandé), tout en protégeant temporairement les balises de
// variable pour qu'un Spintax imbriqué autour d'une variable (ex: "{Bonjour
// {first_name}|Salut {first_name}}") reste malgré tout reconnu comme "le plus
// interne" — voir ce module pour le détail de cette protection.
//
