...
const guides = [
  {
    ...
    keywords: [
      ...
      // Variantes de formulation naturelle sans "mon"/"me" (règle 3 : éviter
      // qu'une phrase courante mais légèrement différente ne rate le guide
      // support et retombe à tort sur un sujet marketing générique — voir
      // localCopywriterEngine.js#composeReply, guide toujours prioritaire).
      'comment je connecte', 'comment connecter whatsapp', 'comment relier whatsapp',
      'relier mon whatsapp', 'connecter mon whatsapp', 'comment lier whatsapp',
    ],
    steps: [
