...
const guides = [
  ...
  {
    key: 'relance_express',
    title: '🔁 Relance Manuelle Express (multi-réseaux)',
    keywords: [
      'relance express', 'relance manuelle', 'relance multi', 'relance client', 'relance automatique',
      'relance prospect',
    ],
    steps: [
      'L\'onglet "📇 Relance Manuelle Express" centralise le suivi de vos contacts/prospects à relancer, sans dépendre d\'un seul canal.',
      'Chaque prospect à relancer apparaît dans une file d\'attente que vous traitez manuellement (contrôle total, pas d\'envoi automatique en votre absence) — vous marquez chaque relance comme "envoyée" une fois le message effectivement transmis sur le réseau choisi (WhatsApp, Telegram...).',
      'Cette approche volontairement manuelle protège vos comptes : un envoi de masse automatique et non supervisé sur des prospects est justement le type de comportement détecté et sanctionné par les plateformes (voir anti-ban).',
    ],
  },
  {
    key: 'pwa',
