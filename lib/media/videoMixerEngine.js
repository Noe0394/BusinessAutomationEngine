...
// Échappement volontairement simplifié pour le filtre "drawtext" (notoirement
// fragile à échapper correctement dans tous les cas) : les apostrophes sont
// remplacées par une apostrophe typographique plutôt que de reproduire la
// séquence d'échappement standard (```'\\\\\\''```), peu lisible et source
// d'erreurs — un compromis raisonnable pour du texte marketing court
// (titres, prix, numéros de contact), pas un éditeur de texte général.
